...
class TaskDataStore(private val context: Context) {
    ...
    private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = Constants.TASK_DATASTORE_NAME)
    ...
    companion object {
        private val TASK_THEME_KEY = booleanPreferencesKey(name = Constants.TASK_DATASTORE_THEME_KEY)
    }
